...
ZoomWH = [b'\x10\x02\xf4\x02  \x00\x01\x90\x10\x03\xeal',
          b'\x10\x02\xf4\x02  \x00\x00\xc8\x10\x03\x02\xa0',
          b'\x10\x02\xf4\x02  \x00\x00d\x10\x03v\xc6']

ZoomBH = [b'\x10\x02\xf4\x02\x00 \x00\x01\x90\x10\x03\xe2\xd8',
          b'\x10\x02\xf4\x02\x00 \x00\x00\xc8\x10\x03\n\x14',
          b'\x10\x02\xf4\x02\x00 \x00\x00d\x10\x03~r']

# parse_status_response(bytes(status_smple1))

[print(format_bytes(i)) for i in ZoomBH]